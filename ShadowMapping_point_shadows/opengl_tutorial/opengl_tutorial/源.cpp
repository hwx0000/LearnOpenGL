...
int main(int argc, char * argv[])
{
	...
	Shader simpleDepthShader = Shader("genCubeSMap.vert", "genCubeSMap.frag", "genCubeSMap.geom");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		for (int i = 0; i < 6; i++)
		{
			string str = "shadowMatrices[" +
				std::to_string(i) + "]";
			simpleDepthShader.setMat4(str.c_str(), shadowTransforms[i]);
		}
		...
		sceneShader.use();
		glm::mat4 projection =
			glm::perspective(glm::radians(90.0f), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
